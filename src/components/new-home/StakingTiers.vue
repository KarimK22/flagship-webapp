...
const tiers = [
  ...
  },
  {
    ...
    multiplier: '5x',
    stakeMin: '$50,000+',
    borderClass: 'border-[#F1E6FA]/20 hover:border-[#F1E6FA]/40',
    glowClass: 'bg-[#F1E6FA]/15',
    badgeBgClass: 'bg-[#F1E6FA]/10 border border-[#F1E6FA]/20',
    textClass: 'text-[#F1E6FA]',
    checkClass: 'text-[#F1E6FA]',
