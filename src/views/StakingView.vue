...
const displayPowerMiles = computed(() => isConnected.value ? formatNumberToUS(totalPowerMiles.value) : '0')
const displayHoldingTotal = computed(() => isConnected.value ? formatNumber(totalStakedLingo.value, 2) : '0')
  ...
  <div class="py-10 px-4 md:px-6 flex flex-col items-center">
        ...
        <div class="flex gap-2 items-start">
          ...
          <div class="flex flex-col">
            <h1
              ...
              :class="isConnected ? 'text-lavender' : 'text-purple-gray/40'"
            >
              {{ displayPowerMiles }}
            </h1>
    ...
    <div class="w-full max-w-[720px] relative">
      ...
      <div
        ...
        :class="{ 'blur-[3px] pointer-events-none select-none': !isConnected }"
      >
        <StakingCalculator />
      </div>

      <!-- Wallet overlay (only when disconnected) -->
      <Transition
      ...
      >
        ...
        >
          ...
          <div class="relative flex flex-col items-center gap-3 text-center px-6">
            ...
            <span class="text-purple-gray/70 text-sm max-w-[260px]">
              See your staking rewards, spins, and prizes
            </span>
          </div>
        </div>
      </Transition>
